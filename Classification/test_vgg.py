...
# Testing
save_model_path = './image_classification/VGG/VGG'
batch_size = 64
n_samples = 10
top_n_predictions = 5
...
def test_model(tmpFeatures):
    ...
    with tf.Session(graph=loaded_graph) as sess:
        ...
        np.save('accuracy_MC', test_batch_acc_total/test_batch_count)
        np.save('softmax_MC', test_batch_softmax)
        np.save('entropy_MC', test_batch_entropy)

...
batch_size = 100
checkpoint_steps = 5
save_model_path = './image_classification/OneConcreteKL'

# Load VGG19 model, define loss, train, and accuracy operation
logits = nets.VGG19_Concrete(x, is_training=True, classes=10, one_parameter=True)
model = tf.identity(logits, name='logits')

# Compute ARM Gradients
kl_weight = tf.placeholder_with_default(1e-8, shape=())

model_scope = 'vgg19_concrete'
...
save_model_path = './image_classification/Concrete'
batch_size = 64
n_samples = 10
top_n_predictions = 5

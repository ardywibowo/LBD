...
def build_deeplabv3_plus_concrete(inputs, num_classes, preset_model='DeepLabV3+', frontend="ResNet101", weight_decay=1e-5, is_training=True, pretrained_dir="models", pretrained_file="xception_65.ckpt",one_parameter=False):
    """
    ...
    logits, end_points, frontend_scope, init_fn  = frontend_builder.build_frontend(inputs, frontend, pretrained_dir=pretrained_dir, is_training=is_training,pretrained_file=pretrained_file,one_parameter=one_parameter)
...
def build_deeplabv3_plus(inputs, num_classes, preset_model='DeepLabV3+', frontend="ResNet101", weight_decay=1e-5, is_training=True, pretrained_dir="models", pretrained_file="xception_65.ckpt"):
    """
    ...
    logits, end_points, frontend_scope, init_fn  = frontend_builder.build_frontend(inputs, frontend, pretrained_dir=pretrained_dir, is_training=is_training,pretrained_file=pretrained_file)
...
def build_deeplabv3_plus_bayesian(inputs, first_pass, batch_size, num_classes, preset_model='DeepLabV3+', frontend="ResNet101", weight_decay=1e-5, is_training=True, pretrained_dir="models", pretrained_file="xception_65.ckpt",one_parameter=False):
    """
    Builds the DeepLabV3 model with LBD. 
    ...
    Returns:
      DeepLabV3 model with LBD
    """

    logits, end_points, frontend_scope, init_fn  = frontend_builder.build_frontend_bayesian(inputs, first_pass, batch_size, frontend, pretrained_dir=pretrained_dir, is_training=is_training,pretrained_file=pretrained_file,one_parameter=one_parameter)
...
#    net = tf.concat((encoder_features, decoder_features), axis=3)
    ...
    net = slim.conv2d(net, num_classes, [1, 1], activation_fn=None, scope='logits')
    #segmentation_maps = slim.conv2d(net, num_classes, [1, 1], activation_fn=None, scope='logits')
    #variance_maps = slim.conv2d(net, num_classes, [1, 1], activation_fn=None, scope='logits')
